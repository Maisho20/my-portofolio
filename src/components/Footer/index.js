const Footer = () => {
  return (
    // <footer className="max-w-screen bg-gray-900">
    //   <div className="container mx-auto px-5 flex flex-col justify-center">
    //     <div className="text-center font-bold text-4xl mb-2 bg-gray-200c">
    //       <h1 className="self-center text-xl font-semibold whitespace-nowrap text-white">
    //         Contacs
    //       </h1>
    //     </div>
    //     {/* icons */}
    //     <div class="flex mb-4 sm:justify-center sm:mt-0">
    ...
    //     <span class="text-sm sm:text-center text-gray-400 mb-5">
    //       © 2023{" "}
